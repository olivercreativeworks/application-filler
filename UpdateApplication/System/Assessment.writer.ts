...
export namespace AssessmentWriter{  
    ...
    export function updateStudentAssessments(studentData: DynamicGrid<MyGlobals.Student>):DynamicGrid<MyGlobals.Student>{
        return updateAssessments(studentData, getAssessmentObj())
    }
